...
**IMPORTANTE:** El rediseño de Home (D-V1.3-03) está **fuera del alcance de Fase 2**. 

- **Home permanece con su estructura actual** (secciones editoriales: Nearby - Spots, For You - Spots, Recommended - Spots, etc.)
- Este documento queda como **referencia para futuras fases** cuando se implemente el rediseño de Home
- **Solo la sección "Comportamiento del Diario" está en alcance de Fase 2** (ver sección correspondiente más abajo)

**Referencia:** `definitions/FLOWYA V1.3/ROADMAP_TECNICO_V1_3.md` - Fase 2
...
**Referencias:**
- Decisiones canónicas: `definitions/FLOWYA V1.3/DECISIONES_CANONICAS_V1_3.md` - D-V1.3-03 (fuera de alcance Fase 2), D-V1.3-04
- Reglas canónicas V1.2: `definitions/FLOWYA V1.2/BITACORA_V1_2.md` - Ajuste 06, Ajuste 07

---

## CONCEPTO: HOME COMO "ESTADO DEL VIAJE" (FUTURO)

**Nota:** Esta sección describe el rediseño futuro de Home, **NO está en alcance de Fase 2**.
...
**Nota:** Esta sección **SÍ está en alcance de Fase 2**.
