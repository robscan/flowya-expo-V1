...
export default function RootLayout() {
                  ...
                  <ThemeProvider value={colorScheme === 'dark' ? DarkTheme : DefaultTheme}>
                      <View style={styles.container}>
                        <Stack>
                          ...
                          <Stack.Screen name="shared-map" options={{ presentation: 'card', headerShown: false }} />
                        </Stack>
  ...
  // GestureHandlerRootView solo en plataformas nativas (bloquea eventos en web)
  if (Platform.OS === 'web') {
    return <View style={styles.container}>{appContent}</View>;
  }
